...
- [ ] U4 `ψ/lab/04-index` — create IVF_PQ index on 100k vectors; measure brute-force vs indexed latency and recall; look at `_indices/` on disk
- [ ] U2 `ψ/lab/02-vectors` — vector column, `search(vec)`, `_distance`; needed to read U4 output
- [ ] U3 `ψ/lab/03-filters-hybrid` — prefilter vs postfilter recall, FTS index, hybrid
...
- [ ] U5 `ψ/lab/05-versions` — checkout, restore, compaction, disk size
...
## Done
- [x] U1 `ψ/lab/01-lancedb-basics` — table, fragments, manifests (2026-09-10)
